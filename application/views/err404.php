            ...
            <div class="container">
                <div class="row">
                    <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="error-section" style="background-image: url(<?php assets("images/bg-404.png")?>)">
                            <img src="<?php assets("images/404.png")?>" alt="" class="img-fluid">
                            <div class="error-section-content">
                                <h1 class="display-6 text-white">This may happen if you entered the wrong URL.</h1>
                                <p> </p>
                                <a href="<?php echo site_url()?>" class="btn btn-secondary btn-lg">Back to dashboard</a>
                            </div>
                        </div>
                    </div>
                </div>
