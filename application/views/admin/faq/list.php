	    ...
	    <tbody>
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu pull-right">
					<li><?php echo anchor(admin_url('faq/update/'.$faq->id),'Update');?></li>
					<li><?php echo anchor(admin_url('faq/delete/'.$faq->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); ?></li>
				</ul>
			</div>
		    </td>
	        </tr>
