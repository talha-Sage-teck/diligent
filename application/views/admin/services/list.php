	    ...
	    <tbody>
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu pull-right">
					<li><?php echo anchor(site_url($this->url_prefix.'services/update/'.$services->id),'Update');?></li>
					<li><?php echo anchor(site_url($this->url_prefix.'services/delete/'.$services->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); ?></li>
				</ul>
			</div>
		    </td>
	        </tr>
