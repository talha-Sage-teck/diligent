...
<?php 
	    ...
	    <div class="form-group">
				...
				<div class="col-sm-10">
                <textarea class="form-control" rows="3" name="title" id="title" placeholder="title"><?php echo $title; ?></textarea>
	    ...
	    <div class="form-group">
                <label for="created_at" class="col-sm-2 form-label">Created at </label>
				<div class="col-sm-10">
	    ...
	    <a href="<?php echo admin_url('services') ?>" class="btn btn-default">Cancel</a>
    </div>
              <!-- /.box-footer -->
	</form>    </div>
    <!-- /.card-body -->
