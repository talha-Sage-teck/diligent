...
<div class="card-datatable table-responsive">
	    ...
	    <tbody>
            <?php
            $start = 0;
            foreach ($testimonials_data as $testimonials)
            {
                ?>
                <tr>
		    <td><?php echo ++$start ?></td>
		    <td><?php echo $testimonials->name ?></td>
		    <td><?php echo $testimonials->designation ?></td>
		    <td><img src="<?php echo base_url('uploads/testimonials/thumbs/'.$testimonials->image) ?>" style="width:50px" /></td>
		    <td><?php echo $testimonials->date ?></td>
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu pull-right">
					<li><?php echo anchor(site_url($this->url_prefix.'testimonials/update/'.$testimonials->id),'Update');?></li>
					<li><?php echo anchor(site_url($this->url_prefix.'testimonials/delete/'.$testimonials->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); ?></li>
				</ul>
			</div>
		    </td>
	        </tr>
