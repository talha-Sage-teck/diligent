...
<div class="card-datatable table-responsive">
	    ...
	    <tbody>
		    ...
		    <td><?php echo $notification->read_status ?></td>
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu pull-right">
					<li><?php echo anchor(site_url($this->url_prefix.'notification/update/'.$notification->id),'Update');?></li>
					<li><?php echo anchor(site_url($this->url_prefix.'notification/delete/'.$notification->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); ?></li>
				</ul>
			</div>
		    </td>
	        </tr>
