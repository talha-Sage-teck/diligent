...
<input class="form-check-input" type="checkbox" value="<?php echo $group->id ?>" name="usergroups[]"  <?php if ($this->ion_auth->in_group($group->id, $id)) echo 'checked'?>>
<span class="form-check-label"><?php echo $group->name ?></span>
</label>
           <?php }?>
           </div>
          </div>
        ...
        <div class="box-footer">
          ...
          <a href="<?php echo admin_url('users') ?>" class="btn btn-default">Cancel</a> </div>
        <!-- /.box-footer -->
      </form>
