<div class="container-fluid dashboard-content">
		  ...
		  echo form_open($frm_action, $attributes) ?>
										...
										<div class="form-group">
											...
											<div class="form-group">
												<button type="button" class="btn btn-warning" id="addservicesblock" data-ajax_url="<?php echo site_url("challan/ajax_service_block")?>" data-counter="0"><i class="fa fa-fw fa-plus text-success"></i> Add More Items</button>
											</div>
