                            ...
                            <li class="nav-item ">
								...
								<div id="submenu-2" class="collapse submenu <?php echo menu_active('quotation', false) ? 'show' : ''?>" style="">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link " <?php menu_active('create|create_action')?> href="<?php echo site_url('quotation/addquotation')?>"><i class="fa fa-fw fa-plus"></i> Add Quotation</a>
										</li>
										<li class="nav-item">
...
<!-- 														
							<li class="nav-item ">
								...
								<div id="submenu-4" class="collapse submenu <?php echo menu_active('inspection', false) ? 'show' : ''?>" style="">
									<ul class="nav flex-column">
										...
										<li class="nav-item">
											<a class="nav-link <?php menu_active('quotation')?>" href="<?php echo site_url('quotation')?>"><i class="fa fa-fw fa-list"></i> List</a>
										</li>
										<?php }?>
							...
							<li class="nav-item ">
								...
								<a class="nav-link <?php menu_active('items')?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-handshake"></i> Items</a>
								<div id="submenu-3" class="collapse submenu <?php echo menu_active('items', false) ? 'show' : ''?>" style="">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link" <?php menu_active('create|create_action')?> href="<?php echo site_url('items/create')?>"><i class="fa fa-fw fa-plus"></i> Add Item </a>
										</li>
										<li class="nav-item">
