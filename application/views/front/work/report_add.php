		...
		<div class="col-xl-10">
			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="page-header" id="top">
						<h2 class="pageheader-title" style="text-transform: capitalize"><?php echo $action?> Work completion Report </h2>
						<div class="page-breadcrumb">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo site_url()?>" class="breadcrumb-link">Dashboard</a>
									</li>
									<li class="breadcrumb-item active" aria-current="page"><?php echo $action?> Report</li>
								</ol>
							</nav>
						</div>
					</div>
		  ...
		  echo form_open($frm_action, $attributes) ?>
							<div class="form-group d-none">
								...
								<textarea  id="summernote" class="form-control" name="content" rows="6" placeholder="Write "><?php echo $content ?></textarea>
							</div>
							<div class="form-group">
								<label for="completed_by" class="col-form-label">Completed By Name:</label>
								<input id="completed_by" name="completed_by" type="text" class="form-control" value="<?php echo $completed_by ?>">
							</div>
							<div class="form-group">
								<label for="job_ref" class="col-form-label">Job Reference</label>
							...
							<div class="form-group">
								...
								<button class="btn btn-primary btn-block" type="submit">Next <i class="fas fa-chevron-right"></i></button>
							</div>
