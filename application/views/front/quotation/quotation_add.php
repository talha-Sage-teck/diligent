		...
		<div class="col-xl-10">
		  ...
		  echo form_open($frm_action, $attributes) ?>
							...
							<div class="form-group">
								...
								<input id="attention" name="attention" type="text" class="form-control">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input id="workduration" name="workduration" type="number" class="form-control">
							</div>
							<div class="form-group">
								<label for="workduration" class="col-form-label">Extra Content</label>
								<textarea class="form-control" id="summernote" name="quotation_text" rows="6" placeholder="Write Descriptions"><?php echo $default_quotation_html?></textarea>
							</div>
							<input type="hidden" value="<?php echo $inspection_id?>" name="inspection_id">
							<div class="form-group">
