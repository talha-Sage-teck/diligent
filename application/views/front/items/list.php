				...
				<td style="text-align:center">
					<div class="dropdown ml-auto">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink5">
							<?php echo anchor(site_url("items/update/".$items->id),"Update", array("class" => "dropdown-item"));?>
							<?php if ( $this->ion_auth->in_group( "admin" ) ) {?>
							<?php echo anchor(site_url("items/delete/".$items->id),"Delete", array("onclick" => "javasciprt: return confirm('Are You Sure ?')", "class" => "dropdown-item")); ?>
							<?php }?>
						</div>
					</div>
				</td>
