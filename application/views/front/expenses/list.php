...
<div class="container-fluid  dashboard-content">
	...
	<a href="<?php echo site_url($pslug."/create") ?>" type="button" class="btn  btn-primary"><i class="fa fa-plus"></i> Add <?php echo $page_title ?></a><div class="row">
	    ...
	    <tbody>
		    ...
		    <td><?php echo $expenses->title ?></td>
		    <td><?php echo $expenses->description ?></td>
		    <td><img src="<?php echo base_url("uploads/expenses/$expenses->image") ?>" width="100" /></td>
		    <td><?php echo $expenses->created_at ?></td>
		    ...
		    <td style="text-align:center">
					<div class="dropdown ml-auto">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink5">
							<?php echo anchor(site_url("expenses/update/".$expenses->id),'<i class="fas fa-edit"></i>  Update', array("class" => "dropdown-item"));?>
							<?php echo anchor(site_url("expenses/read/".$expenses->id),'<i class="fas fa-eye"></i>  View Details', array("class" => "dropdown-item"));?>
							<?php if ( $this->ion_auth->in_group( "admin" ) ) {?>
							<?php echo anchor(site_url("expenses/delete/".$expenses->id),"<i class='fas fa-trash-alt'></i> Delete", array("onclick" => "javasciprt: return confirm('Are You Sure ?')", "class" => "dropdown-item")); ?>
							<?php }?>
						</div>
					</div>
				</td>
